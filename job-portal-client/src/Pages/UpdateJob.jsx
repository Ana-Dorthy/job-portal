      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
         ...
         {/*2nd row*/}
            ...
            <div className="lg:w-1/2 w-full">
                ...
                <input type="text" placeholder="$80k" defaultValue={maxPrice} {...register("maxPrice")} className="create-job-input"/>
            </div>
            </div>
           {/* 3rd row*/}
       ...
       <div className="lg:w-1/2 w-full">
                ...
                <input type="date" placeholder="2023-10-18" defaultValue={postingDate} {...register("postingDate")} className="create-job-input"/>
            </div>

            <div className="lg:w-1/2 w-full">
                <label className='block mb-2 text-lg'>Choose your Experience</label>
